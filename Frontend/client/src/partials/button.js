...
function Button(props){
    ...
    return (
        <button  data-bs-toggle={props.dataBsToggle} data-bs-target={props.dataBsTarget} className={`${btnColor()} ${buttonClass.defBtn} ${flex()} `}src={props.icon} onClick={props.onClick} 
