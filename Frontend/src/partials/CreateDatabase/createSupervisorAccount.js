import createAccount from "../../Styles/partials/CreateDatabase/createDB.module.css"
...
function CreateSupervisorAccount(props)
{
    ...
    const createSupervisorsURL="http://localhost:4000/user/createSupervisor";
...
return (
    ...
    <div className={`modal-dialog modal-dialog-centered modal-lg `}>
      ...
      <option disabled  value="" > Select Internship Supervior Company</option>
      {companies.map((c) => (
