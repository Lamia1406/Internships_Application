import createFacultyClass from '../Styles/partials/createFaculty.module.css'
...
{
    const getAllUniversities = "http://localhost:4000/v1/university/allUniversities"
    const createFacultyURL="http://localhost:4000/v1/university/createFaculty";
...
return (
    ...
    <div className={`modal-dialog modal-dialog-centered modal-lg `}>
      ...
      <p> Or </p> 
     <div className={createFacultyClass.addUniversity} >
         <Button content="Add University" color="white"  dataBsToggle="modal" dataBsTarget="#university"/>
          </div>
            </div>
            </div>
           </div>
           <div className={createFacultyClass.inputDiv} >
            ...
            <div className={createFacultyClass.navigationBtn}>
                <Button content="Cancel" color="white" dataBsToggle="modal" dataBsTarget="#depResponsible"/>
            </div>
      </div>
          </div>
