...
import requestClass from '../Styles/main/yourApp.module.css';
...
useEffect(()=>{
  ...
  return ( 
     <>
     <Layout pageTitle = "Requests" header ="Internships" content ={
   ...
   {...(app.student ?  {levelOfStudy :app.student.level_of_study} : {})}
               ...
               (!newInternship || newInternship.length == 0) && (!internships || internships.length== 0) && (
                     ...
                     <NotAvailable message ="No available applications"/>
               </>
               )
